...
type AuthCaptureRequest struct {
	...
	CaptureAmount              *Money          `json:"captureAmount,omitempty"`
...
// is modeled the same way, as a plain (non-pointer) Money, since this
...
func AuthCapture(ctx context.Context, t *Transport, hb HeaderBuilder, req AuthCaptureRequest) (AuthCaptureResponse, error) {
