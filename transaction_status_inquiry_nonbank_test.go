...
func TestTransactionStatusInquiryNonBank_NonTwoXXResponseCodeIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrBadRequest) {
		t.Errorf("TransactionStatusInquiryNonBank() error = %v, want errors.Is(err, ErrBadRequest)", err)
	}
}
...
func TestTransactionStatusInquiryNonBank_NonTwoXXStatusWithTwoXXBodyIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrInternalServerError) {
		t.Errorf("TransactionStatusInquiryNonBank() error = %v, want errors.Is(err, ErrInternalServerError)", err)
	}
}
