...
func VANotifyPaymentIntrabank(ctx context.Context, t *Transport, hb HeaderBuilder, req VANotifyPaymentIntrabankRequest) (VANotifyPaymentIntrabankResponse, error) {
