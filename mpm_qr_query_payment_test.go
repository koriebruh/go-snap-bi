...
func TestQRMPMQueryPayment_NonTwoXXResponseCodeIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrBadRequest) {
		t.Errorf("QRMPMQueryPayment() error = %v, want errors.Is(err, ErrBadRequest)", err)
	}
}
...
func TestQRMPMQueryPayment_NonTwoXXStatusWithTwoXXBodyIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrInternalServerError) {
		t.Errorf("QRMPMQueryPayment() error = %v, want errors.Is(err, ErrInternalServerError)", err)
	}
}
