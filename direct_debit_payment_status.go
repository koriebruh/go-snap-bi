...
// HeaderBuilder needs except Body, which DirectDebitPaymentStatus sets
...
// precedent.
func DirectDebitPaymentStatus(ctx context.Context, t *Transport, hb HeaderBuilder, req DirectDebitPaymentStatusRequest) (DirectDebitPaymentStatusResponse, error) {
