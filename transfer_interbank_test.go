...
func TestInterbankTransfer_NonTwoXXResponseCodeIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrBadRequest) {
		t.Errorf("InterbankTransfer() error = %v, want errors.Is(err, ErrBadRequest)", err)
	}
}
...
func TestInterbankTransfer_NonTwoXXStatusWithTwoXXBodyIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrInternalServerError) {
		t.Errorf("InterbankTransfer() error = %v, want errors.Is(err, ErrInternalServerError)", err)
	}
}
