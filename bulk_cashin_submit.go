...
// HeaderBuilder needs except Body, which SubmitBulkCashIn sets itself
...
func SubmitBulkCashIn(ctx context.Context, t *Transport, hb HeaderBuilder, req SubmitBulkCashInRequest) (SubmitBulkCashInResponse, error) {
