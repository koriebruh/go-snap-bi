...
func TransferToOTCCreatePayment(ctx context.Context, t *Transport, hb HeaderBuilder, req TransferToOTCCreatePaymentRequest) (TransferToOTCCreatePaymentResponse, error) {
