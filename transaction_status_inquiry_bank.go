...
func TransactionStatusInquiryBank(ctx context.Context, t *Transport, hb HeaderBuilder, req TransactionStatusInquiryBankRequest) (TransactionStatusInquiryBankResponse, error) {
