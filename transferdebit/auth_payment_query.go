...
// modeled as *snap.Money since research explicitly marks the container
// Optional (amount O, members M) — the package's established rule for
// an Optional container is *snap.Money regardless of its members' own
...
// AuthPayment). hb must already carry every field snap.HeaderBuilder needs
