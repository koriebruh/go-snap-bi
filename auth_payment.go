...
// carry every field HeaderBuilder needs except Body, which AuthPayment
...
func AuthPayment(ctx context.Context, t *Transport, hb HeaderBuilder, req AuthPaymentRequest) (AuthPaymentResponse, error) {
