...
func TestDirectDebitPayment_NonTwoXXResponseCodeIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrBadRequest) {
		t.Errorf("DirectDebitPayment() error = %v, want errors.Is(err, ErrBadRequest)", err)
	}
}
...
func TestDirectDebitPayment_NonTwoXXStatusWithTwoXXBodyIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrInternalServerError) {
		t.Errorf("DirectDebitPayment() error = %v, want errors.Is(err, ErrInternalServerError)", err)
	}
}
