...
// HeaderBuilder needs except Body, which DirectDebitPaymentCancel sets
...
func DirectDebitPaymentCancel(ctx context.Context, t *Transport, hb HeaderBuilder, req DirectDebitPaymentCancelRequest) (DirectDebitPaymentCancelResponse, error) {
