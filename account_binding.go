...
// every field HeaderBuilder needs except Body, which AccountBinding sets
...
// token issuance.
func AccountBinding(ctx context.Context, t *Transport, hb HeaderBuilder, req AccountBindingRequest) (AccountBindingResponse, error) {
