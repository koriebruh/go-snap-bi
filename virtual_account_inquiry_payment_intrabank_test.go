...
func TestVAInquiryPaymentIntrabank_NonTwoXXResponseCodeIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrBadRequest) {
		t.Errorf("VAInquiryPaymentIntrabank() error = %v, want errors.Is(err, ErrBadRequest)", err)
	}
}
...
func TestVAInquiryPaymentIntrabank_NonTwoXXStatusWithTwoXXBodyIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrInternalServerError) {
		t.Errorf("VAInquiryPaymentIntrabank() error = %v, want errors.Is(err, ErrInternalServerError)", err)
	}
}
