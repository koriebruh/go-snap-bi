...
func TestTransactionStatusInquiryBank_NonTwoXXResponseCodeIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrBadRequest) {
		t.Errorf("TransactionStatusInquiryBank() error = %v, want errors.Is(err, ErrBadRequest)", err)
	}
}
...
func TestTransactionStatusInquiryBank_NonTwoXXStatusWithTwoXXBodyIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrInternalServerError) {
		t.Errorf("TransactionStatusInquiryBank() error = %v, want errors.Is(err, ErrInternalServerError)", err)
	}
}
