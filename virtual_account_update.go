...
// carry every field HeaderBuilder needs except Method and Body, which
...
func UpdateVA(ctx context.Context, t *Transport, hb HeaderBuilder, req UpdateVARequest) (UpdateVAResponse, error) {
