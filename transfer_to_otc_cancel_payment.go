...
// field HeaderBuilder needs, including EndpointURL, which the caller
...
func TransferToOTCCancelPayment(ctx context.Context, t *Transport, hb HeaderBuilder, req TransferToOTCCancelPaymentRequest) (TransferToOTCCancelPaymentResponse, error) {
