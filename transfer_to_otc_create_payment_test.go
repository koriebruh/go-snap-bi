...
func TestTransferToOTCCreatePayment_NonTwoXXResponseCodeIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrBadRequest) {
		t.Errorf("TransferToOTCCreatePayment() error = %v, want errors.Is(err, ErrBadRequest)", err)
	}
}
...
func TestTransferToOTCCreatePayment_NonTwoXXStatusWithTwoXXBodyIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrInternalServerError) {
		t.Errorf("TransferToOTCCreatePayment() error = %v, want errors.Is(err, ErrInternalServerError)", err)
	}
}
