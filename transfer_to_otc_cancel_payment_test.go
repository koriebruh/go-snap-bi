...
func TestTransferToOTCCancelPayment_NonTwoXXResponseCodeIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrBadRequest) {
		t.Errorf("TransferToOTCCancelPayment() error = %v, want errors.Is(err, ErrBadRequest)", err)
	}
}
...
func TestTransferToOTCCancelPayment_NonTwoXXStatusWithTwoXXBodyIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrInternalServerError) {
		t.Errorf("TransferToOTCCancelPayment() error = %v, want errors.Is(err, ErrInternalServerError)", err)
	}
}
