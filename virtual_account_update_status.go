...
// must already carry every field HeaderBuilder needs except Method and
...
func UpdateStatusVA(ctx context.Context, t *Transport, hb HeaderBuilder, req UpdateStatusVARequest) (UpdateStatusVAResponse, error) {
