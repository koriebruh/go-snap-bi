...
// HeaderBuilder needs except Body, which DirectDebitPaymentRefund sets
...
func DirectDebitPaymentRefund(ctx context.Context, t *Transport, hb HeaderBuilder, req DirectDebitPaymentRefundRequest) (DirectDebitPaymentRefundResponse, error) {
