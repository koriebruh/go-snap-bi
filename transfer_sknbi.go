...
// field HeaderBuilder needs except Body, which SKNBITransfer sets
...
func SKNBITransfer(ctx context.Context, t *Transport, hb HeaderBuilder, req SKNBITransferRequest) (SKNBITransferResponse, error) {
