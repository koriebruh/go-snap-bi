...
// no method override). hb must already carry every field HeaderBuilder
...
func QRMPMPaymentH2H(ctx context.Context, t *Transport, hb HeaderBuilder, req QRMPMPaymentH2HRequest) (QRMPMPaymentH2HResponse, error) {
