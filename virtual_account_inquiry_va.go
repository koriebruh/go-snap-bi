...
// every field HeaderBuilder needs except Body, which InquiryVA sets
// itself so the exact marshaled bytes are used for both signing and the
// wire body.
func InquiryVA(ctx context.Context, t *Transport, hb HeaderBuilder, req InquiryVARequest) (InquiryVAResponse, error) {
