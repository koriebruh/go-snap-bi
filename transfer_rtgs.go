...
// HeaderBuilder needs except Body, which RTGSTransfer sets itself so
...
func RTGSTransfer(ctx context.Context, t *Transport, hb HeaderBuilder, req RTGSTransferRequest) (RTGSTransferResponse, error) {
