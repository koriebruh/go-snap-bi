...
func TestDirectDebitPaymentStatus_NonTwoXXResponseCodeIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrBadRequest) {
		t.Errorf("DirectDebitPaymentStatus() error = %v, want errors.Is(err, ErrBadRequest)", err)
	}
}
...
func TestDirectDebitPaymentStatus_NonTwoXXStatusWithTwoXXBodyIsError(t *testing.T) {
	...
	if !errors.Is(err, ErrInternalServerError) {
		t.Errorf("DirectDebitPaymentStatus() error = %v, want errors.Is(err, ErrInternalServerError)", err)
	}
}
