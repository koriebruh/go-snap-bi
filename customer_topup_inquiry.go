...
func AccountInquiryCustomerTopUp(ctx context.Context, t *Transport, hb HeaderBuilder, req AccountInquiryCustomerTopUpRequest) (AccountInquiryCustomerTopUpResponse, error) {
